...
#================================================================================================= 
def TotZonenKompensation(tau, tauStart):
    absTau = abs(tau)
...
#================================================================================================= 
def MotorSimulation(tauLeft, tauRight):
    if (tauLeft!=0) or (tauRight!=0):
        tauLeft =  TotZonenKompensation(tauLeft, tauStartLeft)
        tauRight = TotZonenKompensation(tauRight, tauStartRight)
...
def eKarrenSimulation(vLinearQ, vAngularQ, rcKeyStatus):
...
def ReceiveRaw():
   ...
   msg = ""
   try: 
      (data, clientAddr) = sock.recvfrom(bufsize)
   except socket.error:
      pass
   else:   
